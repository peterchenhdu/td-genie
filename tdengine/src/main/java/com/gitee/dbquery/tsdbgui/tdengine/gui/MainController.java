...
import com.zhenergy.zntsdb.common.dto.db.DbConfigAddDTO;
import com.zhenergy.zntsdb.common.dto.db.DbConfigUpdateDTO;
...
import com.zhenergy.zntsdb.common.dto.stb.StableAddDTO;
import com.zhenergy.zntsdb.common.dto.stb.StableUpdateDTO;
...
//                Node node = event.getPickResult().getIntersectedNode();                //给node对象添加下来菜单；
            ...
            if (clickNodeData.getType().equals(NodeTypeEnum.CONNECTION)) {
                ...
                nodeClickMenu.getItems().addAll(exportSQLMenuItem, createQueryMenuItem, createDbMenuItem, updateDbMenuItem, createTbMenuItem);
            } else {
                nodeClickMenu.getItems().addAll(exportSQLMenuItem, createQueryMenuItem, createTbMenuItem, updateTbMenuItem);
            }
