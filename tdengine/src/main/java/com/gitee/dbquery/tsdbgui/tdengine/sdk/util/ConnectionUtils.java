...
//        } finally {
//            com.gitee.dbquery.tsdbgui.tdengine.sdk.util.RestConnectionUtils.close(statement, rs);
//        }
//    }
//
//    /**
...
//            throw new RuntimeException(e.getMessage());
//        } finally {
//            com.gitee.dbquery.tsdbgui.tdengine.sdk.util.RestConnectionUtils.close(statement);
//        }
//    }
//
//    /**
...
//        List<SystemVariableResDTO> list = com.gitee.dbquery.tsdbgui.tdengine.sdk.util.RestConnectionUtils.executeQuery(connection, "SHOW VARIABLES;", SystemVariableResDTO.class);
